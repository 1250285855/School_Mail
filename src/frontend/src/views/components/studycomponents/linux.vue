...
import { linuxDownload } from './downloadComponents/index.js';
...
<template>
    <div class="clanguage">
        <div class="window">
            ...
            <div class="cmain">
                <!-- Teacher -->
                <div class="teacher fl" @click="open_linzidaren"  style="cursor: pointer;">
                ...
                <div class="download">
                    ...
                    <div v-for="dldcomponents in linuxDownload" :key="dldcomponents.id">

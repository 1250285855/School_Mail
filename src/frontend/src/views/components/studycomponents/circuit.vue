                ...
                <div class="cmain">
                    ...
                    <div class="download">
                        ...
                        <div class="download_information">
                            <div class="text fl">
                                <p>
                                    电路与电子技术课程原理性较强，注重实验技能的培养。课程主要内容包括电路的基本概念、基本定律（定理）、基本理论；电路分析和计算的一般方法；电路的工作原理及电路的基本作用；变压器和电动机的基本原理和应用；安全用电的基本常识；放大电路、集成电路原理和逻辑分析电子及器件的外特性和应用技术。通过本课程学习使学生具有分析电路一般问题的能力和电路的基本操作技能；具有识读电子电路图、计算电路基本物理量的能力；具备应用电路理论解决生产、生活中的实际问题，及学习和应用电工电子新知识、新技术的能力。
                                </p>
                            </div>
